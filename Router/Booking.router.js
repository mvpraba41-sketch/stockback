...
const { createBooking, getBookings, getCustomers, searchProductsGlobal,editBooking,deleteBooking,getBookingPDF,updateBooking,getBookingById,debugDelete } = require('../Controller/Booking.controller');
...
router.get('/booking/:id/debug', debugDelete);
